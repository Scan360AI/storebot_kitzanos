...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      secondary:
        'bg-secondary-500 text-white hover:bg-secondary-600 focus:ring-secondary-500 shadow-sm hover:shadow',
      outline:
      ...
      danger:
        'bg-error text-white hover:bg-red-600 focus:ring-error shadow-sm hover:shadow',
    };
