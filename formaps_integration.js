...
function initializeFormaps() {
    ...
    // NUOVO: Crea il modal per Formaps
    createFormapsModal();
}

// Nuova funzione per creare il modal
function createFormapsModal() {
    // Rimuovi l'iframe container esistente
    ...
    const modalHTML = `
        ...
        <!-- Pulsante flottante per riaprire -->
    ...
    // Inizializza Lucide per le nuove icone
    lucide.createIcons();

    // Apri automaticamente il modal
    openFormapsModal();
}

// Funzioni per controllare il modal
window.openFormapsModal = function() {
    ...
    // Mostra messaggio con l'indirizzo
